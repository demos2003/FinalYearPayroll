            ...
            <div className='top_card'>
                <div className='cardhold'>
                    <div className='slip slip1'>
                        ...
                        <div className='content'><div style={{fontSize:"10px"}}>EMPLOYEES:</div> <div style={{fontSize:"35px"}}>50</div></div>
                        <div className='IconB'><AiOutlineUser/></div>
                        </div>
                        
                        </div>
                    <div className='slip slip2'>
                    <div className='slip_hold'>
                        <div className='content'><div style={{fontSize:"10px"}}>SPRINT:</div> <div style={{fontSize:"35px"}}>12</div></div>
                        <div className='IconB'><BiRun/></div>
                        </div>
                    </div>
                    <div className='slip slip3'>
                    <div className='slip_hold'>
                        <div className='content'><div style={{fontSize:"10px"}}>SICK LEAVE:</div> <div style={{fontSize:"35px"}}>0</div></div>
                        <div className='IconB'><MdOutlineSick/></div>
                        </div>
                    </div>
                    <div className='slip slip4'>  <div className='slip_hold'>
                        <div className='content'><div style={{fontSize:"10px"}}>APPOINTMENTS:</div> <div style={{fontSize:"35px"}}>2</div></div>
                        <div className='IconB'><AiOutlineCalendar/></div>
                        </div></div>
                </div>
